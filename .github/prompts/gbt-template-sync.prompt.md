...
This skill provides a reusable workflow for auditing and syncing files between your current repository and a template repository.
...
- Compare file statuses — Check which files are up-to-date, need updates, are customized, or have diverged from the template.
